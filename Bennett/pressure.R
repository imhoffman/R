...
KCON <- read.csv("2010-03-KCON-header.txt",skip=0,header=TRUE,stringsAsFactors=FALSE,sep=",")
...
plot(h,freq=FALSE,ylab="Percentage of Measurements (%)",xlab="Atmospheric Pressure (Pa)", main="Histogram of Hourly Pressure Measurements",sub="Concord, NH, USA, 2010 Mar",col='grey')
